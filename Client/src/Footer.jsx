        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <Link to={"/"} class="flex items-center">
              <img
                src={homeus}
                class="mr-3 h-6 sm:h-9 md:h-20 bg-transparent"
                alt="HomeUs Logo"
              />
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3">
            <div>
              <h2 class="mb-6 text-base font-semibold text-gray-900 dark:text-white">
                Về chúng tôi
              </h2>
            ...
            <div>
              ...
              <ul class="text-gray-600 dark:text-gray-400">
                <li class="mb-4">
                  <i class="fa-solid fa-phone mr-2"></i>0337289239
                </li>
                <li class="mb-4">
                  <i class="fa-solid fa-location-dot mr-2"></i>48 Cao Thắng - Đà
                  Nẵng
                </li>
                <li class="mb-4">
