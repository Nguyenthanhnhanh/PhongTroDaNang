    ...
    <footer class="mt-5 p-4 bg-gray-100 sm:p-6 dark:bg-gray-800">
      <div class="mt-4 mx-auto max-w-screen-xl">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3">
                  <div>
                      ...
                      <ul class="text-gray-600 dark:text-gray-400">
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Giới thiệu</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Blog</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Quy chế hoạt động</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Quy định sử dụng</Link>
                          </li>
                          <li class="">
                              <Link to={'/'} class="hover:underline">Chính sách bảo mật</Link>
                          </li>
                          
                      </ul>
                  </div>
                  <div>
                      <h2 class="mb-6 text-base font-semibold text-gray-900 dark:text-white">Hỗ trợ</h2>
                      <ul class="text-gray-600 dark:text-gray-400">
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Câu hỏi thường gặp</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Hướng dẫn đăng tin</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Bảng giá dịch vụ</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Quy định đăng tin</Link>
                          </li>
                          <li class="mb-4">
                              <Link to={'/'} class="hover:underline">Giải quyết khiếu nại</Link>
                          </li>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 HomeUs. All Rights Reserved.
              </span>
