    ...
    <div className="py-4 px-8 flex flex-col min-h-[75vh] max-w-6xl mx-auto">
      {add.length < 1 ? (
        <div className="mt-4">
          ...
          <div class="mt-4 text-base font-semibold md:text-base lg:text-base">
            Tìm thấy {room.length} kết quả.
          </div>
          {room.length == 0 && (
            <div className="mt-16 md:col-span-2 lg:col-span-3">
              <div class="text-center text-gray-500 text-xl font-semibold tracking-tight leading-none md:text-2xl lg:text-3xl">
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      <span class="text-2xl font-bold text-gray-900 dark:text-white">
                        {(item.packageLong.price / 1000000).toFixed(0)}
                      </span>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr class="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="px-6 py-4">{truncate(add[0]?.address, 45)}</td>
                  <td class="px-6 py-4">{truncate(add[1]?.address, 45)}</td>
                </tr>
                <tr class="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                ...
                <tr class="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="px-6 py-4">{add[0].areas || 0}</td>
                  <td class="px-6 py-4">{add[1].areas || 0}</td>
                </tr>
                <tr class="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                  ...
                  <td class="px-6 py-4">{add[0].numberBed || 0}</td>
                  <td class="px-6 py-4">{add[1].numberBed || 0}</td>
                </tr>
                <tr class="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                  ...
                  <td class="px-6 py-4">{add[0].reviews.length || 0}</td>
                  <td class="px-6 py-4">{add[1].reviews.length || 0}</td>
                </tr>
