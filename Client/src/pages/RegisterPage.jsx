        ...
        <div className="-mt-16 max-w-8xl container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="mx-auto w-full px-4 text-center lg:w-8/12">
              <h1 class="mt-8 text-2xl font-bold tracking-tight leading-none text-white md:text-3xl lg:text-4xl dark:text-white">
                HomeUs
              </h1>
            </div>
          </div>
              ...
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" onSubmit={registerUser}>
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Nguyễn Thành Nhanh"
                      value={name}
                  ...
                  <div>
                    <label
                      ...
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      Thêm ảnh nếu bạn muốn trở thành người kiểm duyệt(Không bắt
                      buộc)
                    </label>
                    <PhotosUploader
                  ...
                  <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer mt-4 mb-4">
                    <input
                      ...
                      checked={isCheck}
                      name="parking"
                      onChange={checkingData}
                    />
                    <span>Muốn làm người kiểm duyệt</span>
                  </label>
                  <p className="quote">
                    Chúng tôi sẽ tiến hành xem xét tài khoản của bạn trước khi
                    đồng ý cho trở thành người kiểm duyệt hay không
                  </p>
                  <button
                    type="submit"
        ...
        <div class="w-full bg-white rounded-lg shadow-lg md:mt-0 sm:max-w-md xl:p-0">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" onSubmit={registerUser}>
              ...
              <p className="quote">
                Chúng tôi sẽ tiến hành xem xét tài khoản của bạn trước khi đồng
                ý cho trở thành người kiểm duyệt hay không
              </p>
              <button
                type="submit"
                class="w-full text-white bg-indigo-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
      ...
      <div className="mb-64">
        ...
        <form className="max-w-md mx-auto" onSubmit={registerUser}>
          ...
          <label className="label-upload">
            Thêm ảnh nếu bạn muốn trở thành người kiểm duyệt(Không bắt buộc)
          </label>
          ...
          <p className="quote">
            Chúng tôi sẽ tiến hành xem xét tài khoản của bạn trước khi đồng ý
            cho trở thành người kiểm duyệt hay không
          </p>
