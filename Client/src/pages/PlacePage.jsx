    ...
    <div className="py-4 px-8 flex flex-col min-h-screen max-w-6xl mx-auto">
      <div className="md:grid md:grid-cols-5 gap-4 mb-4">
        <div className="md:col-span-4">
          <h1 class="text-3xl font-semibold tracking-tight leading-none">
            {place.title}
          </h1>
        ...
        <div className="float-right">
          <span class="float-right mb-4 bg-blue-100 text-blue-800 text-s font-medium mr-2 px-2.5 py-0.5 rounded-full border-2 border-blue-400">
            Sẵn sàng giao dịch
          </span>
          <div className="float-right">
            <button
      ...
      <div className="mt-4 md:grid md:grid-cols-3 gap-16">
        <div className="col-span-2">
          ...
          <div className="md:grid md:grid-cols-3 gap-x-8 gap-y-2">
            ...
            {place?.perks?.includes("parking") && (
              <div>
                <i class="fa-solid fa-square-parking fa-lg mr-2"></i>Bãi giữ xe
              </div>
            )}
            {place?.perks?.includes("tv") && (
              <div>
                <i class="fa-solid fa-tv mr-2"></i>Tivi
              </div>
            )}
            {place?.perks?.includes("radio") && (
              <div>
                <i class="fa-solid fa-radio mr-2"></i>Radio
              </div>
            )}
            {place?.perks?.includes("pets") && (
              <div>
                <i class="fa-solid fa-dog fa-lg mr-2"></i>Thú cưng
              </div>
            )}
            {place?.perks?.includes("entrance") && (
              <div>
                <i class="fa-solid fa-signs-post fa-lg mr-2"></i>Lối đi riêng
              </div>
            )}
          </div>
          ...
          <div className="md:grid md:grid-cols-3 gap-x-8 gap-y-2">
            <div>
              <i class="fa-solid fa-shirt mr-2"></i>Giặt đồ
            </div>
            <div>
              <i class="fa-solid fa-dog fa-lg mr-2"></i>Dắt thú cưng đi dạo
            </div>
            <div>
              <i class="fa-solid fa-utensils fa-lg mr-2"></i>Bữa sáng
            </div>
            <div>
              <i class="fa-solid fa-face-laugh-squint mr-2"></i>Khu giải trí
            </div>
          </div>
          ...
          <div className="md:grid md:grid-cols-2 gap-x-8 gap-y-2">
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-school fa-xl mr-3"></i>Trường học
              </div>
            ...
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-hospital fa-xl mr-3"></i>Bệnh viện
              </div>
              <div className="grid grid-cols-2 gap-2 py-2">
                <div>Địa điểm</div>
                <div className="text-right font-bold">
            ...
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-utensils fa-xl mr-3"></i>Ăn uống
              </div>
              <div className="grid grid-cols-2 gap-2 py-2">
                <div>Địa điểm</div>
                <div className="text-right font-bold">
            ...
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-briefcase fa-xl mr-3"></i>Văn phòng
              </div>
              <div className="grid grid-cols-2 gap-2 py-2">
                <div>Địa điểm</div>
                <div className="text-right font-bold">
            ...
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-face-laugh-squint fa-xl mr-3"></i>Giải trí
              </div>
              <div className="grid grid-cols-2 gap-2 py-2">
                <div>Địa điểm</div>
                <div className="text-right font-bold">
            ...
            <div>
              <div className="border-b border-gray-400 border-dashed pb-2 font-bold">
                <i class="fa-solid fa-cart-shopping fa-xl mr-3"></i>Mua sắm
              </div>
              <div className="grid grid-cols-2 gap-2 py-2">
                <div>Địa điểm</div>
                <div className="text-right font-bold">
        ...
        <div>
          <div class="my-8 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex px-4 pt-4 font-bold">Liên hệ với</div>
            <div className="grid grid-cols-4 my-4 mx-4 flex flex-col items-center pb-4 border-b border-gray-400">
              ...
              >
                <h5 class="mb-2 text-xl font-medium text-gray-900 hover:text-blue-800 dark:text-white">
            ...
            <div className="grid m-4">
              <a
                href="#"
                class="px-4 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                <i class="fa-solid fa-phone mr-2"></i>Gọi điện thoại
              </a>
            </div>
            ...
            <div class="md:grid md:grid-cols-2 m-4 gap-4 border-b border-gray-400 pb-4">
              ...
              >
                <i class="fa-solid fa-comment-dots mr-2"></i>Zalo
              </a>
              <a
                href="#"
                class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700"
              >
                <i class="fa-brands fa-facebook-messenger mr-2"></i>Messenger
              </a>
              <a
                href="#"
                class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700"
              ...
              <a
                ...
                class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700"
              >
                <i class="fa-solid fa-inbox mr-2"></i>Liên hệ tôi
              </a>
            </div>
            <div className="grid m-4">
              <a
                href="#"
                class="text-blue-700 border border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium hover:bg-gray-100 rounded-lg text-sm px-5 py-2 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800"
              >
                <i class="fa-solid fa-phone mr-2"></i>Chat với HomeUs
              </a>
        ...
        <div className="col-span-2">
          <div className="border p-6 rounded-2xl gap-2 cursor-pointer bg-white shadow rounded-lg">
            ...
            <div className="mt-4 grid gap-y-4 grid-cols-2 flex items-center">
              ...
              <span class="bg-blue-100 text-blue-800 text-base text-center font-medium px-2.5 py-1 rounded-lg dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                {place?.packageLong.longPackageDate}
              </span>
              <div className="font-semibold">Chu kỳ theo</div>
              <span class="bg-green-100 text-green-800 text-base text-center font-medium px-2.5 py-1 rounded-lg dark:bg-gray-700 dark:text-blue-400 border border-green-400">
                Tháng
              </span>
              <div className="font-semibold">Giá / tháng</div>
              <span class="bg-pink-100 text-pink-800 text-base text-center font-medium px-2.5 py-1 rounded-lg dark:bg-gray-700 dark:text-blue-400 border border-pink-400">
        ...
        <div className="col-span-2">
          <div className="border p-6 rounded-2xl gap-2 cursor-pointer bg-white shadow rounded-lg">
            ...
            <div className="mt-4 grid gap-y-4 grid-cols-2 flex items-center">
              ...
              <span class="bg-yellow-100 text-yellow-800 text-base text-center font-medium px-2.5 py-1 rounded-lg dark:bg-gray-700 dark:text-blue-400 border border-yellow-400">
