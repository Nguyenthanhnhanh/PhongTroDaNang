          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link to={"/"} className="flex items-center">
              ...
              usePathname === "/register" ? (
                <img
                  src={homeuswhite}
                  className="mr-3 h-6 sm:h-9 md:h-14 bg-transparent"
                  alt="HomeUs Logo"
                />
              ) : (
                <img
            ...
            <div className="flex items-center lg:order-2">
              ...
              <Link
                to={user ? "/account/places/new" : "/login"}
                className="text-white bg-indigo-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              >
                Đăng tin
              </Link>
              <button
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                {/* <li>
                            <a href="#" className={usePathname==="/"||usePathname==="/price-table"||usePathname==="/login"||usePathname==="/register"?"block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 text-white":"block py-2 pr-4 pl-3 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white"} aria-current="page">Hướng dẫn</a>
                        </li> */}
                <li>
                  <div
