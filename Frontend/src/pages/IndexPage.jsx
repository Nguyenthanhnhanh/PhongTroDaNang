      ...
      <div>
            ...
            <Row className="">
              <Col className="" span={6}>
                <img
                  ...
                  alt="verify"
                />
                <div className="text-center support-item text-xl">
                  Cam kết xác thực
                </div>
              </Col>
              <Col span={6}>
              ...
              <Col span={6}>
                <img
                  ...
                  alt="verify"
                />
                <span className="text-center support-item text-xl">
                  An toàn giao dịch
                </span>
              </Col>
              <Col span={6}>
        ...
        <div className="mt-8 py-4 px-8 flex flex-col min-h-screen max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight leading-none dark:text-white">
          ...
          <div className="my-10 space-y-8 space-x-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:space-y-0 md:space-x-0">
            {places.length > 0 &&
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              <a
                href="/search"
                className="inline-flex items-center font-medium text-primary-600 hover:text-blue-800 dark:text-primary-500 dark:hover:text-primary-700"
              >
                Xem tất cả
                <svg
          ...
          <div className="my-8 grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {listBooker.map((item) => (
