  ...
  return (
      ...
      <main className="grid gap-6 my-12 mx-12 px-2 mx-auto">
        <aside className>
              ...
              <div className="relative">
                <img
                  ...
                  alt=""
                          ...
                          <p className="font-semibold">{ detail?.acceptBooker && (<span className="text-green-500">Chuyên viên </span>) }{detail?.name}</p>
              <div className="text-sm leading-normal text-gray-600 flex justify-center items-center">
          ...
          <h2 className="p-2 m-2 font-bold">Các Dự Án Đã Đại Diện</h2>
