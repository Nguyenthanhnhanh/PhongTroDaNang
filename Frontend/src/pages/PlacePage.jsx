        ...
        <div className="mt-4 space-y-8 space-x-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:space-y-0 md:space-x-0">
          {places.length > 0 && places.map(place => (
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl">
              ...
              <span onClick={()=>handleCancel(place._id)} className="cursor-pointer relative z-20 bg-red-100 text-green-800 text-base text-center font-medium px-2.5 py-1 rounded-lg dark:bg-gray-700 dark:text-blue-400 border border-green-400">Xóa</span>
            </div>
          ))}
        </div>
        {places.length == 0 &&
