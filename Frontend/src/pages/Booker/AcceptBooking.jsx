                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end gap-4">
                        <Tooltip title="Xem thông tin chi tiết">
                          <button className="bg-blue-500 hover:bg-blue-700 text-white font-light py-1 px-3 rounded-full" onClick={() => handleRedirect(e._id)}><i className="fa-solid fa-info fa-xs"></i></button>
                        </Tooltip>
                      </div>
                    </td>
                  </tr>
