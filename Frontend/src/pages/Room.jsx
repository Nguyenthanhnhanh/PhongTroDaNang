        ...
        <>
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr className="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                  ...
                  <td className="px-6 py-4">{truncate(add[0]?.address, 45)}</td>
                  <td className="px-6 py-4">{truncate(add[1]?.address, 45)}</td>
                </tr>
                <tr className="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                ...
                <tr className="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4">{add[0].areas || 0}</td>
                  <td className="px-6 py-4">{add[1].areas || 0}</td>
                </tr>
                <tr className="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                  ...
                  <td className="px-6 py-4">{add[0].numberBed || 0}</td>
                  <td className="px-6 py-4">{add[1].numberBed || 0}</td>
                </tr>
                <tr className="bg-white border-b border-gray-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th
                    scope="row"
                  ...
                  <td className="px-6 py-4">{add[0].reviews.length || 0}</td>
                  <td className="px-6 py-4">{add[1].reviews.length || 0}</td>
                </tr>
